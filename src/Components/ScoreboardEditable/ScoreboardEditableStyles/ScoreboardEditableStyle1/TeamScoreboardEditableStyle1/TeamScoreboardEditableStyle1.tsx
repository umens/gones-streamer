...
import './TeamScoreboardEditableStyle1.css';
import ReactDropzone from "react-dropzone";
import { ChromePicker } from 'react-color';
import { Timeout, Team as TeamModel, FileUp, TeamPossession } from "../../../../../Models";
import { Utilities } from "../../../../../Utils";

class TeamScoreboardEditableStyle1 extends Component<BaseTeamScoreboardEditableProps, BaseTeamScoreboardEditableState> {
  ...
  render() {
    ...
    return (
      <div id='teamScoreboardEditStyle1' style={{ position: 'relative' }}>
...
export { TeamScoreboardEditableStyle1 };
